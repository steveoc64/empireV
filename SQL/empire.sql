...
--
-- Table structure for table `army_characteristics`
--

DROP TABLE IF EXISTS `army_characteristics`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `army_characteristics` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `descr` varchar(32) COLLATE utf8_unicode_ci NOT NULL,
  `me_activity_bonus` int(11) NOT NULL,
  `me_attack_bonus` int(11) NOT NULL,
  `me_defend_bonus` int(11) NOT NULL,
  `initiative_bonus` int(11) NOT NULL,
  `bombard_bonus` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `army_characteristics`
--

LOCK TABLES `army_characteristics` WRITE;
/*!40000 ALTER TABLE `army_characteristics` DISABLE KEYS */;
INSERT INTO `army_characteristics` VALUES (2,'French 1805 - 1807',5,0,0,0,0),(1,'Other',0,0,0,0,0);
/*!40000 ALTER TABLE `army_characteristics` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `ci_sessions` VALUES ('40e63969cd02b092d56ee3e3da73c068','203.122.194.178','Opera/9.80 (X11; Linux i686; U; en) Presto/2.10.229 Version/11.62',1337828864,''),('4e921aff63528d9da663f9e345b26f2e','203.122.194.178','Mozilla/5.0 (X11; Linux i686; rv:12.0) Gecko/20100101 Firefox/12.0',1338636942,'a:4:{s:7:\"user_id\";s:2:\"20\";s:8:\"username\";s:5:\"admin\";s:12:\"is_logged_in\";b:1;s:4:\"role\";s:1:\"A\";}'),('188b311c50d2a1f908a814d40a17e53b','203.122.194.178','Mozilla/5.0 (X11; Linux i686; rv:12.0) Gecko/20100101 Firefox/12.0',1338532256,'a:4:{s:7:\"user_id\";s:2:\"20\";s:8:\"username\";s:5:\"admin\";s:12:\"is_logged_in\";b:1;s:4:\"role\";s:1:\"A\";}'),('30888317811874a1f423cae16598cc06','95.49.180.222','Mozilla/5.0 (Macintosh; Intel Mac OS X 10_6_8) AppleWebKit/534.57.2 (KHTML, like Gecko) Version/5.1.7 Safari/534.57.2',1338452165,''),('5520dd16f2b11f943fd6aaacb9ea72df','49.176.34.196','Mozilla/5.0 (Linux; U; Android 4.0.3; en-au; HTC_One_X Build/IML74K) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 ',1337223411,''),('562deaecc15832003a803ab279543466','203.122.194.178','Mozilla/5.0 (Linux; U; Android 4.0.3; en-au; HTC_One_X Build/IML74K) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0 ',1337327938,'a:5:{s:9:\"user_data\";s:0:\"\";s:7:\"user_id\";s:2:\"10\";s:8:\"username\";s:8:\"augereau\";s:12:\"is_logged_in\";b:1;s:4:\"role\";s:1:\"P\";}');
...
CREATE TABLE `game` (
  ...
  `attacker_commander` int(11) NOT NULL,
  `defender_commander` int(11) NOT NULL,
  `attacker_characteristics` int(11) NOT NULL,
  `defender_characteristics` int(11) NOT NULL,
...
INSERT INTO `game` VALUES (4,'Weekend test II',4,'',6,2,10,11,9,10,9,2,1,'<p>Small meeting engagement at Jena</p>','<p>You are to clear the area around Vierzehnheiligen</p>','<p>You are to advance and inflict total defeat on the French before Napoleon arrives</p>','','',40,60,0,0,'',0,1);
...
--
-- Table structure for table `game_bombardment_unit`
--

DROP TABLE IF EXISTS `game_bombardment_unit`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `game_bombardment_unit` (
  `game_id` int(11) NOT NULL,
  `turn_number` int(11) NOT NULL,
  `unit_id` int(11) NOT NULL,
  `moved` int(11) NOT NULL,
  `modifiers` int(11) NOT NULL,
...
--
-- Dumping data for table `game_bombardment_unit`
--

LOCK TABLES `game_bombardment_unit` WRITE;
/*!40000 ALTER TABLE `game_bombardment_unit` DISABLE KEYS */;
INSERT INTO `game_bombardment_unit` VALUES (4,2,116,200,0,11,2,'Phase 2 and 3'),(4,2,115,200,0,11,2,'Phase 2 and 3'),(4,2,224,400,-4,11,2,'Phase 2 and 3'),(4,2,229,400,-4,11,2,'Phase 2 and 3'),(4,2,234,200,0,11,2,'Phase 2 and 3'),(4,2,238,200,0,11,2,'Phase 2 and 3');
/*!40000 ALTER TABLE `game_bombardment_unit` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `game_engagement_initiative` VALUES (4,1,2,230,2,5,1,600),(4,1,2,235,-1,11,2,600),(4,1,2,101,7,11,2,600);
...
INSERT INTO `game_engagement_unit` VALUES (4,1,101,2,0),(4,1,235,2,0),(4,1,230,2,0);
...
INSERT INTO `game_message` VALUES (4,1,5,10,101,'From: General of Division Jacques Desjardin<br>[101] - 1st Division: Desjardin will Attack the village of Vierzehnheiligen','T',1,4,'2012-05-04 12:39:30'),(4,1,4,9,235,'From: Oberst von Erichsen<br>[235] - Light Brigade will Defend the western edge of Vierzehnheiligen','F',1,1,'2012-05-08 11:25:14'),(4,1,3,9,230,'From: General-Leutnant Friedrich Jacob von Holtzendorff<br>[230] - Cavalry Brigade von Holtzendorff will Support the right flank of the light brigade','F',1,1,'2012-05-08 11:25:14'),(4,1,2,9,225,'From: General-Major Christian Friedrich von Schimonsky<br>[225] - Brigade von Schimonsky will March to the south west of Vierzehnheiligen','F',1,2,'2012-05-08 11:25:14'),(4,1,1,9,220,'From: General-Major Johann Friedrich Wilhelm von Müffling<br>[220] - Brigade von Muffling will March to the south west of Vierzehnheiligen','F',1,4,'2012-05-08 11:25:35'),(4,3,1,9,220,'Unit has converted to defend order due to March objective reached','F',2,6,'2012-05-04 10:29:02'),(4,3,2,9,225,'Unit has converted to defend order due to March objective reached','F',2,3,'2012-05-04 10:29:54'),(4,2,1,9,0,'<img src=http://15mm-madness.com/empire/photos/2012-05-04_22-41-061.jpg><br>View from the southern flank looking towards Veirzehnheiligen','F',2,3,'2012-05-08 11:25:35'),(4,2,2,10,0,'<img src=http://15mm-madness.com/empire/photos/2012-05-04_22-41-061.jpg><br>View from the southern flank looking towards Veirzehnheiligen','T',2,5,'2012-05-04 12:40:10'),(4,2,3,20,0,'<img src=http://15mm-madness.com/empire/photos/2012-05-04_22-40-531.jpg><br>Prussian fusiliers take Veirzehnheiligen, as the French approach from the West.<br>','T',2,2,'2012-05-10 01:28:52'),(4,2,4,10,0,'<img src=http://15mm-madness.com/empire/photos/2012-05-04_22-40-531.jpg><br>Prussian fusiliers take Veirzehnheiligen, as the French approach from the West.<br>','T',2,2,'2012-05-04 12:39:42');
...
INSERT INTO `inspiration` VALUES (1,'Charistmatic',10,75,90,5),(2,'Inspirational',5,50,75,3),(3,'Impersonal',0,25,50,1),(4,'Despised',-10,10,25,-1),(2,'Inspiring',5,50,75,3),(4,'Uninspiring',-10,10,25,-1);
...
CREATE TABLE `scenario` (
  ...
  `orbat_attacker` int(11) NOT NULL,
  `orbat_defender` int(11) NOT NULL,
  `attacker_me_activity` int(11) NOT NULL DEFAULT '1',
  `defender_me_activity` int(11) NOT NULL DEFAULT '1',
  `attacker_characteristics` int(11) NOT NULL,
  `defender_characteristics` int(11) NOT NULL,
...
INSERT INTO `scenario` VALUES (4,'Small meeting engagement at Jena','<p>You are to clear the area around Vierzehnheiligen</p>','<p>You are to advance and inflict total defeat on the French before Napoleon arrives</p>',6,'','',11,9,1,1,2,1,'');
...
INSERT INTO `unit` VALUES (200,0,0,'Hohenlohe\'s Army','',1,'T','F',1,0,0,0,0,0,1,0,20,9,'CL','',0),(201,200,0,'Southern Wing Command','',3,'T','F',1,0,0,0,0,0,1,0,20,9,'CL','',0),(202,201,0,'Advanced Guard Division','',4,'T','F',1,0,0,0,0,0,1,0,20,9,'CL','',0),(203,202,0,'Infantry Brigade Belvilaqua','',5,'F','F',1,0,0,0,0,0,1,0,20,9,'CL','',0),(204,203,0,'Müffling Infantry Regiment # 49, two battalions','IR49',10,'F','F',1,1280,10,10,6,5,1,0,20,9,'CL','',0),(205,203,0,'Prince Clemens Saxon Infantry Regiment, two battalions','Prinz Clemens',10,'F','F',2,1280,10,10,6,5,1,0,20,9,'CL','',0),(206,203,0,'Kürfurst Saxon Infantry Regiment, two battalions','Kurfurst',10,'F','F',3,1280,10,10,6,6,1,0,20,9,'CL','',0),(207,203,0,'Hoyer Foot Artillery Battery, six 4-pound guns','',12,'F','F',1,6,10,10,6,6,1,0,20,9,'CL','',0),(208,202,0,'Brigade von Pelet','',5,'F','F',2,0,0,0,0,0,1,0,20,9,'CL','',0),(209,208,0,'Rabenau Fusilier Battalion # 13','FS 13',10,'F','F',4,600,10,10,6,5,1,0,20,9,'CL','',0),(210,208,0,'Pelet Fusilier Battalion # 14','FS 14',10,'F','F',5,600,10,10,6,6,1,0,20,9,'CL','',0),(211,208,0,'Rühle Fusilier Battalion # 15','FS 15',10,'F','F',6,600,10,10,6,5,1,0,20,9,'CL','',0),(212,208,0,'Masars and Valentin Foot Jäger companies','FS Masars',10,'F','F',7,200,10,10,5,5,1,0,20,9,'CL','',0),(213,208,0,'Reimann Foot Artillery Battery, six 6-pound guns','',12,'F','F',2,6,10,10,5,5,1,0,20,9,'CL','',0),(214,202,0,'Cavalry Brigade von Schimmelpfennig','',6,'F','T',1,0,0,0,0,0,1,0,20,9,'CL','',0),(215,214,0,'Schimmelpfennig Hussar Regiment # 6, ten squadrons','Hussar 6',11,'F','F',1,1200,10,20,6,6,1,0,20,9,'CL','',0),(216,214,0,'Gause Horse Artillery Battery # 2, eight 6-pound guns','',12,'F','F',3,8,10,10,6,6,1,0,20,9,'CL','',0),(217,202,0,'Cavalry Brigade von Trützschler','',6,'F','T',2,0,0,0,0,0,1,0,20,9,'CL','',0),(218,217,217,'Saxon Hussar Regiment, eight squadrons','',11,'F','F',2,800,10,20,6,6,1,0,20,9,'CL','',0),(219,201,0,'1st Division','',4,'T','F',2,0,0,0,0,0,1,0,20,9,'CL','',0),(220,219,0,'Brigade von Muffling','',5,'F','T',3,0,0,0,0,0,1,0,20,9,'CL','',0),(221,220,220,'Hahn Grenadier battalion (29/32)','Hahn Gren',10,'F','F',8,600,10,10,3,3,1,0,20,9,'CL','',0),(222,220,220,'Hohenlohe Infantry Regiment # 32, two battalions','IR32',10,'F','F',9,1200,10,10,6,5,1,0,20,9,'CL','',0),(223,220,220,'Sanitz Infantry Regiment # 50, two battalions','IR50',10,'F','F',10,1200,10,10,6,6,1,0,20,9,'CL','',0),(224,220,220,'Giasenapp Foot Artillery battery # 7, six 12-pound guns','',12,'F','F',4,6,10,10,6,6,1,0,20,9,'CL','',0),(225,219,0,'Brigade von Schimonsky','',5,'F','T',4,0,0,0,0,0,1,0,20,9,'CL','',0),(226,225,225,'Sack Grenadier battalion (33/42)','Sack Gren',10,'F','F',11,600,10,10,3,3,1,0,20,9,'CL','',0),(227,225,225,'Grawert Infantry Regiment # 37, two battalions','IR37',10,'F','F',12,1200,10,10,6,5,1,0,20,9,'CL','',0),(228,225,225,'Zastrow Infantry Regiment # 39, two battalions','IR39',10,'F','F',13,1200,10,10,6,6,1,0,20,9,'CL','',0),(229,225,225,'Wolframsdorf Foot Artillery battery # 8, six 12-pound guns','',12,'F','F',5,6,10,10,6,6,1,0,20,9,'CL','',0),(230,219,0,'Cavalry Brigade von Holtzendorff','',6,'F','T',3,0,0,0,0,0,1,0,20,9,'CL','',0),(231,230,230,'Krafft Dragoon Regiment # 11, five squadrons','Dragoon 11',11,'F','F',3,500,10,24,6,6,1,0,20,9,'CL','',0),(232,230,230,'Henkel Cuirassier Regiment # 1, five squadrons','Cuirassier 1',11,'F','F',4,600,10,27,2,5,1,0,20,9,'CL','',0),(233,230,230,'Holtzendorff Cuirassier Regiment # 9, five squadrons','Cuirassier 9',11,'F','F',5,600,10,27,3,5,1,0,20,9,'CL','',0),(234,230,230,'Steinwehr Horse Artillery battery # 9, six 6-pound guns','',12,'F','F',6,6,10,10,6,6,1,0,20,9,'CL','',0),(235,219,0,'Light Brigade','',5,'F','T',5,0,0,0,0,0,1,0,20,9,'CL','',0),(236,235,235,'Erichsen Fusilier battalion # 10','FS 10',10,'F','F',14,600,10,10,6,5,1,0,20,9,'CL','',0),(237,235,235,'Gettkandt Hussar Regiment # 1, ten squadrons','Hussar 1',11,'F','F',6,1000,10,20,6,6,1,0,20,9,'CL','',0),(238,235,235,'Studnitz Prussian Horse Artillery battery # 14 (-), four 4-pound guns','',12,'F','F',7,4,10,10,6,6,1,0,20,9,'CL','',0),(239,201,0,'2nd (Saxon) Division','',4,'T','F',3,0,0,0,0,0,1,0,20,9,'CL','',0),(240,239,0,'Brigade von Burgsdorff','',5,'F','F',6,0,0,0,0,0,1,0,20,9,'CL','',0),(241,240,0,'Thümmel Saxon Infantry Regiment, two battalions','Thummel',10,'F','F',15,1280,10,10,6,6,1,0,20,9,'CL','',0),(242,240,0,'Prince Xavier Saxon Infantry Regiment, two battalions','Prinz Xavier',10,'F','F',16,1280,10,10,6,6,1,0,20,9,'CL','',0),(243,240,0,'Haussmar Saxon Foot Artillery battery, eight 12-pound guns','',12,'F','F',8,8,10,10,6,6,1,0,20,9,'CL','',0),(244,240,0,'Ernst Saxon Foot Artillery battery, eight 12-pound guns','',12,'F','F',9,8,10,10,6,6,1,0,20,9,'CL','',0),(245,239,0,'Brigade von Dyherrn','',5,'F','F',7,0,0,0,0,0,1,0,20,9,'CL','',0),(246,245,0,'Low Saxon Infantry Regiment, two battalions','Low',10,'F','F',17,1280,10,10,6,6,1,0,20,9,'CL','',0),(247,245,0,'Niesemeuschel Saxon Infantry Regiment, two battalions','Niesemeuschel',10,'F','F',18,1280,10,10,6,6,1,0,20,9,'CL','',0),(248,245,0,'Bevilaqua Saxon Infantry Regiment, 2nd battalion','Bevilaqua',10,'F','F',19,640,10,10,6,6,1,0,20,9,'CL','',0),(249,245,0,'Bonniot Saxon Foot Artillery battery # 8, ten 12-pound guns','',12,'F','F',10,10,10,10,6,6,1,0,20,9,'CL','',0),(250,239,0,'Cavalry Brigade: von Kochtitsky','',6,'F','T',4,0,0,0,0,0,1,0,20,9,'CL','',0),(251,250,0,'Mounted Carabinier Saxon Regiment, four squadron','Carabinier Saxon',11,'F','F',7,480,10,27,6,6,1,0,20,9,'CL','',0),(252,250,0,'Kochtitsky Saxon Cuirassier Regiment, four squadrons','Cuirassier Saxon',11,'F','F',8,480,10,27,6,6,1,0,20,9,'CL','',0),(253,250,0,'Prince Albert Saxon Chevau-léger Regiment, four squadrons','Prince Albert Chevleg',11,'F','F',9,480,10,20,6,6,1,0,20,9,'CL','',0),(254,250,0,'Grossman Saxon Horse Artillery battery, ten guns','',12,'F','F',11,10,10,10,6,6,1,0,20,9,'CL','',0),(255,239,0,'Light Brigade von Polenz','',5,'F','F',8,0,0,0,0,0,1,0,20,9,'CL','',0),(256,255,0,'Boguslawsky Prussian Fusilier battalion # 22','FS 22',10,'F','F',20,720,10,10,6,6,1,0,20,9,'CL','',0),(257,255,0,'Polenz Saxon Chevau-léger Regiment, four squadrons','Polenz Chevleg',11,'F','F',10,720,10,20,6,6,1,0,20,9,'CL','',0),(258,255,0,'Studnitz Prussian Horse Artillery battery # 14 (-), five guns','',12,'F','F',12,5,10,10,6,6,1,0,20,9,'CL','',0),(132,117,0,'3rd Foot Artillery Regiment, 3rd company','',12,'F','F',24,4,10,10,4,4,1,0,20,11,'CL','',0),(131,128,0,'Nassau Infantrie Regiment, 1st Bn','1/Nassau',10,'F','F',64,720,10,10,6,6,1,0,20,11,'CL','',0),(130,128,0,'Hesse Darmstadt Fuslier, 2nd Bn','2/HD',10,'F','F',63,640,10,10,6,6,1,0,20,11,'CL','',0),(129,128,0,'Hesse Darmstadt Fuslier, 1st Bn','1/HD',10,'F','F',62,640,10,10,6,6,1,0,20,11,'CL','',0),(128,117,0,'Brigade Allied','',5,'F','F',18,0,0,0,0,0,1,0,20,11,'CL','',0),(127,122,0,'63eme Ligne, 2e Bn','2/63L',10,'F','F',61,720,10,10,6,6,1,0,20,11,'CL','',0),(126,122,0,'63eme Ligne, 1e Bn','1/63L',10,'F','F',60,720,10,10,6,6,1,0,20,11,'CL','',0),(125,122,0,'24eme Ligne, 3e Bn','3/24L',10,'F','F',59,720,10,10,6,6,1,0,20,11,'CL','',0),(124,122,0,'24eme Ligne, 2e Bn','2/24L',10,'F','F',58,720,10,10,6,6,1,0,20,11,'CL','',0),(123,122,0,'24eme Ligne, 1e Bn','1/24L',10,'F','F',57,720,10,10,6,6,1,0,20,11,'CL','',0),(122,117,0,'Brigade d\' Ligne Sarrut','',5,'F','F',17,0,0,0,0,0,1,0,20,11,'CL','',0),(121,118,0,'7eme Legere, 3e Bn','3/7L',10,'F','F',56,720,10,14,4,4,1,0,20,11,'CL','',0),(120,118,0,'7eme Legere, 2e Bn','2/7L',10,'F','F',55,720,10,14,4,4,1,0,20,11,'CL','',0),(119,118,0,'7eme Legere, 1e Bn','1/7L',10,'F','F',54,720,10,14,4,4,1,0,20,11,'CL','',0),(118,117,0,'Brigade d\' Legere Amey','',5,'F','F',16,0,0,0,0,0,1,0,20,11,'CL','',0),(117,100,0,'2nd Division: de Bierre','',4,'T','F',8,0,0,0,0,0,1,0,20,11,'CL','',0),(116,101,101,'6th Horse Artillery Regiment, 2nd company','',12,'F','F',23,4,10,10,4,4,1,0,20,11,'CL','',0),(115,101,101,'3rd Foot Artillery Regiment, 4th company','',12,'F','F',22,4,10,10,4,4,1,0,20,11,'CL','',0),(114,107,0,'105eme Ligne, 3e Bn','3/105',10,'F','F',53,720,10,10,6,6,1,0,20,11,'CL','',0),(113,107,0,'105eme Ligne, 2e Bn','2/105',10,'F','F',52,720,10,10,6,6,1,0,20,11,'CL','',0),(112,107,0,'105eme Ligne, 1e Bn','1/105',10,'F','F',51,720,10,10,6,6,1,0,20,11,'CL','',0),(111,107,0,'44eme Ligne, 3e Bn','3/44',10,'F','F',50,720,10,10,6,6,1,0,20,11,'CL','',0),(110,107,0,'44eme Ligne, 2e Bn','2/44',10,'F','F',49,720,10,10,6,6,1,0,20,11,'CL','',0),(109,107,0,'44eme Ligne, 1e Bn','1/44',10,'F','F',48,720,10,10,6,6,1,0,20,11,'CL','',0),(108,107,0,'14eme Legere, 2e Bn','2/14L',10,'F','F',47,720,10,14,4,4,1,0,20,11,'CL','',0),(107,101,101,'Brigade d\' Ligne Lefranc','',5,'F','F',15,0,0,0,0,0,1,0,20,11,'CL','',0),(106,102,102,'16eme Legere, 4e Bn','4/16L',10,'F','F',46,720,10,14,4,4,1,0,20,11,'CL','',0),(105,102,102,'16eme Legere, 3e Bn','3/16L',10,'F','F',45,720,10,14,4,4,1,0,20,11,'CL','',0),(104,102,102,'16eme Legere, 2e Bn','2/16L',10,'F','F',44,720,10,14,4,4,1,0,20,11,'CL','',0),(103,102,102,'16eme Legere, 1e Bn','1/16L',10,'F','F',43,720,10,14,4,4,1,0,20,11,'CL','',0),(102,101,0,'Brigade d\' Legere Lapisse','',5,'F','T',14,0,0,0,0,0,1,0,20,11,'CL','',0),(101,100,0,'1st Division: Desjardin','',4,'T','T',7,0,0,0,0,0,1,0,20,11,'CL','',0),(100,0,0,'French VII Corps 1806 - Augereau','',2,'T','F',3,0,0,0,0,0,1,0,20,11,'CL','',0),(133,117,0,'6th Horse Artillery Regiment, 2nd company','',12,'F','F',25,4,10,10,4,4,1,0,20,11,'CL','',0),(134,100,0,'Brigade d\' Cheval  Auguste Durosnel','',6,'F','T',6,0,0,0,0,0,1,0,20,11,'CL','',0),(135,134,134,'7e Chasseurs','',11,'F','F',13,480,10,20,6,6,1,0,20,11,'CL','',0),(136,134,134,'20e Chasseurs','',11,'F','F',14,360,10,20,6,6,1,0,20,11,'CL','',0),(137,134,0,'6th Horse Artillery Regiment, 5th company','',12,'F','F',26,4,10,10,4,4,1,0,20,11,'CL','',0),(138,100,0,'Corps Artillery','',4,'T','F',9,0,0,0,0,0,1,0,20,11,'CL','',0),(139,138,0,'Heavy battery','',12,'F','F',27,4,10,10,5,5,1,0,20,11,'CL','',0),(140,138,0,'1e Artillery d Pied','',12,'F','F',28,6,10,10,5,5,1,0,20,11,'CL','',0),(141,138,0,'1e Artillery d pied','',12,'F','F',29,6,10,10,5,5,1,0,20,11,'CL','',0),(142,138,0,'2e Artillery d Cheval','',12,'F','F',30,4,10,10,5,5,1,0,20,11,'CL','',0);
...
INSERT INTO `user` VALUES (8,'umpire','51af21c411643bd7a7e8d77e0d3c9acd','2012-04-20 18:33:11','steveoc64@gmail,com','T','U',0,0,1,''),(9,'duke of brunswick','5d2bbc279b5ce75815849d5e3f0533ec','2012-05-04 18:15:35','steveoc64@gmail,com','F','P',4,219,2,''),(10,'augereau','88e77ff74930f37010370c296d14737b','2012-05-16 21:29:34','steveoc64@gmail,com','F','P',4,101,1,''),(20,'admin','21232f297a57a5a743894a0e4a801fc3','2012-06-01 16:01:06','steveoc64@gmail.com','F','A',4,0,0,''),(25,'wartensleben','b50cd72da9f57f8bf6880303ff5b7622','2012-05-04 13:53:52','steveoc64@gmail.com','F','P',0,0,2,'');
...
-- Dump completed on 2012-06-03 10:30:20
